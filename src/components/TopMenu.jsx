      ...
      <div className="container">
        <div className="menuHeader">
          <div className="headerLeft">
            <div>
              <img src="https://jj2084jj.github.io/radioWeb/public/14-1.svg" alt="" />
            </div>
            <div>
              <img src="https://jj2084jj.github.io/radioWeb/mbc-logo-b.png" alt="" />
            </div>
          </div>
        ...
        <div className="menuContents">
          <div className="slideHeader">
            <ul>
              ...
              <li>
                <a href="https://imnews.imbc.com/pc_main.html" target={"_blank"}>뉴스</a>
              </li>
              <li>
          ...
          <div className="slideSubHeader">
            <ul>
              <li>
                <a href="http://with.mbc.co.kr/pr/press/" target={"_blank"}>보도자료</a>
              </li>
              <li>
              ...
              <ul>
                <li>
                  <div className="onVideoImg">
                    <img src="https://jj2084jj.github.io/radioWeb/mbc-img01.png" alt="" />
                  </div>
                ...
                <li>
                  <div className="onVideoImg">
                    <img src="https://jj2084jj.github.io/radioWeb/mbc-img-2.png" alt="" />  
                  </div>
                  <div className="onVideoTit">
                    <h4>라디오 스타</h4>
                    <p>MBC every1</p>
            ...
            <div className="liveVideoContents">
              <ul>
                <li>
                  ...
                  <img src="https://jj2084jj.github.io/radioWeb/mbc-img-3.png" alt="" />
                    </div>
                ...
                <li>
                  <div className="liveVideoImg">
                  <img src="https://jj2084jj.github.io/radioWeb/mbc-img-4.png" alt="" /></div>
                  <div className="liveVideoTit">
                    <h4>공화국 시리즈</h4>
